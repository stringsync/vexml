...
describe('render', () => {
	...
	it.concurrent('renders structure_single_stave.png', async () => {
		expect(
			await scores.screenshot('structure_single_stave.musicxml'),
	...
	it.concurrent('renders structure_grand_staff.png', async () => {
		expect(
			await scores.screenshot('structure_grand_staff.musicxml'),
	...
	it.concurrent('renders structure_two_parts.png', async () => {
		expect(
			await scores.screenshot('structure_two_parts.musicxml'),
	...
	it.concurrent('renders structure_mixed_staves.png', async () => {
		expect(
			await scores.screenshot('structure_mixed_staves.musicxml'),
	...
	it.concurrent('renders structure_part_group_symbols.png', async () => {
		expect(
			await scores.screenshot('structure_part_group_symbols.musicxml', {
				showPartLabels: true,
			}),
	...
	it.concurrent('renders structure_part_groups.png', async () => {
		expect(
			await scores.screenshot('structure_part_groups.musicxml'),
	...
	it.concurrent('renders structure_part_group_bracket_top.png', async () => {
		expect(
			await scores.screenshot('structure_part_group_bracket_top.musicxml', {
	...
	it.concurrent('renders structure_tab_parts.png', async () => {
		expect(
			await scores.screenshot('structure_tab_parts.musicxml'),
		).toMatchScreenshot('structure_tab_parts.png');
	});

	it.concurrent('renders structure_notation_and_tab_parts.png', async () => {
		expect(
			await scores.screenshot('structure_notation_and_tab_parts.musicxml'),
	...
	it.concurrent('renders structure_part_labels.png', async () => {
		expect(
			await scores.screenshot('structure_part_labels.musicxml', {
				showPartLabels: true,
			}),
	...
	it.concurrent('renders colors.png', async () => {
		expect(
			await scores.screenshot('colors.musicxml', {
				showPartLabels: true,
	...
	it.concurrent('renders font_notation_petaluma.png', async () => {
		expect(
			await scores.screenshot('font_notation_petaluma.musicxml', {
	...
	it.concurrent('renders clef_treble.png', async () => {
		expect(await scores.screenshot('clef_treble.musicxml')).toMatchScreenshot(
			'clef_treble.png',
		);
	});
	...
	it.concurrent('renders clef_treble_octave.png', async () => {
		expect(
			await scores.screenshot('clef_treble_octave.musicxml'),
	...
	it.concurrent('renders clef_treble_bass.png', async () => {
		expect(
			await scores.screenshot('clef_treble_bass.musicxml'),
	...
	it.concurrent('renders clef_tab_6_string.png', async () => {
		expect(
			await scores.screenshot('clef_tab_6_string.musicxml'),
	...
	it.concurrent('renders clef_tab_4_string.png', async () => {
		expect(
			await scores.screenshot('clef_tab_4_string.musicxml'),
	...
	it.concurrent('renders clef_tab_staff_tuning.png', async () => {
		expect(
			await scores.screenshot('clef_tab_staff_tuning.musicxml'),
	...
	it.concurrent('renders clef_notation_and_tab.png', async () => {
		expect(
			await scores.screenshot('clef_notation_and_tab.musicxml'),
	...
	it.concurrent('renders clef_notation_and_tab_tuned.png', async () => {
		expect(
			await scores.screenshot('clef_notation_and_tab_tuned.musicxml'),
	...
	it.concurrent('renders clef_notation_and_tab_bracket.png', async () => {
		expect(
			await scores.screenshot('clef_notation_and_tab_bracket.musicxml'),
	...
	it.concurrent('renders clef_c.png', async () => {
		expect(await scores.screenshot('clef_c.musicxml')).toMatchScreenshot(
			'clef_c.png',
		);
	});
	...
	it.concurrent('renders clef_mid_measure.png', async () => {
		expect(
			await scores.screenshot('clef_mid_measure.musicxml'),
	...
	it.concurrent('renders percussion_display_step.png', async () => {
		expect(
			await scores.screenshot('percussion_display_step.musicxml'),
	...
	it.concurrent('renders clef_percussion.png', async () => {
		expect(
			await scores.screenshot('clef_percussion.musicxml'),
	...
	it.concurrent('renders staff_details_lines.png', async () => {
		expect(
			await scores.screenshot('staff_details_lines.musicxml'),
	...
	it.concurrent('renders key.png', async () => {
		expect(await scores.screenshot('key.musicxml')).toMatchScreenshot(
			'key.png',
		);
	});
	...
	it.concurrent('renders key_modes.png', async () => {
		expect(await scores.screenshot('key_modes.musicxml')).toMatchScreenshot(
			'key_modes.png',
		);
	});
	...
	it.concurrent('renders key_non_traditional.png', async () => {
		expect(
			await scores.screenshot('key_non_traditional.musicxml'),
	...
	it.concurrent('renders time.png', async () => {
		expect(await scores.screenshot('time.musicxml')).toMatchScreenshot(
			'time.png',
		);
	});
	...
	it.concurrent('renders time_compound.png', async () => {
		expect(await scores.screenshot('time_compound.musicxml')).toMatchScreenshot(
			'time_compound.png',
		);
	});
	...
	it.concurrent('renders time_single_number.png', async () => {
		expect(
			await scores.screenshot('time_single_number.musicxml'),
	...
	it.concurrent('renders time_senza_misura.png', async () => {
		expect(
			await scores.screenshot('time_senza_misura.musicxml'),
	...
	it.concurrent('renders note.png', async () => {
		expect(await scores.screenshot('note.musicxml')).toMatchScreenshot(
			'note.png',
		);
	});
	...
	it.concurrent('renders note_density.png', async () => {
		expect(await scores.screenshot('note_density.musicxml')).toMatchScreenshot(
			'note_density.png',
		);
	});
	...
	it.concurrent('renders dotted_notes.png', async () => {
		expect(await scores.screenshot('dotted_notes.musicxml')).toMatchScreenshot(
			'dotted_notes.png',
		);
	});
	...
	it.concurrent('renders rest.png', async () => {
		expect(await scores.screenshot('rest.musicxml')).toMatchScreenshot(
			'rest.png',
		);
	});
	...
	it.concurrent('renders rest_pitched.png', async () => {
		expect(await scores.screenshot('rest_pitched.musicxml')).toMatchScreenshot(
			'rest_pitched.png',
		);
	});
	...
	it.concurrent('renders rest_multi_measure.png', async () => {
		expect(
			await scores.screenshot('rest_multi_measure.musicxml', {
				measureNumbering: 'every',
			}),
	...
	it.concurrent('renders accidentals.png', async () => {
		expect(await scores.screenshot('accidentals.musicxml')).toMatchScreenshot(
			'accidentals.png',
		);
	});
	...
	it.concurrent('renders divisions_change.png', async () => {
		expect(
			await scores.screenshot('divisions_change.musicxml'),
	...
	it.concurrent('renders invisible_notes.png', async () => {
		expect(
			await scores.screenshot('invisible_notes.musicxml'),
	...
	it.concurrent('renders note_color.png', async () => {
		expect(await scores.screenshot('note_color.musicxml')).toMatchScreenshot(
			'note_color.png',
		);
	});
	...
	it.concurrent('renders tempo.png', async () => {
		expect(await scores.screenshot('tempo.musicxml')).toMatchScreenshot(
			'tempo.png',
		);
	});
	...
	it.concurrent('renders tempo_beat_unit_dot.png', async () => {
		expect(
			await scores.screenshot('tempo_beat_unit_dot.musicxml'),
	...
	it.concurrent('renders words.png', async () => {
		expect(await scores.screenshot('words.musicxml')).toMatchScreenshot(
			'words.png',
		);
	});
	...
	it.concurrent('renders dynamics.png', async () => {
		expect(await scores.screenshot('dynamics.musicxml')).toMatchScreenshot(
			'dynamics.png',
		);
	});
	...
	it.concurrent('renders wedges.png', async () => {
		expect(await scores.screenshot('wedges.musicxml')).toMatchScreenshot(
			'wedges.png',
		);
	});
	...
	it.concurrent('renders octave_shift.png', async () => {
		expect(await scores.screenshot('octave_shift.musicxml')).toMatchScreenshot(
			'octave_shift.png',
		);
	});
	...
	it.concurrent('renders direction_lines.png', async () => {
		expect(
			await scores.screenshot('direction_lines.musicxml'),
	...
	it.concurrent('renders navigation.png', async () => {
		expect(await scores.screenshot('navigation.musicxml')).toMatchScreenshot(
			'navigation.png',
		);
	});
	...
	it.concurrent('renders lyrics.png', async () => {
		expect(await scores.screenshot('lyrics.musicxml')).toMatchScreenshot(
			'lyrics.png',
		);
	});
	...
	it.concurrent('renders lyrics_melisma.png', async () => {
		expect(
			await scores.screenshot('lyrics_melisma.musicxml'),
	...
	it.concurrent('renders lyrics_elision.png', async () => {
		expect(
			await scores.screenshot('lyrics_elision.musicxml'),
	...
	it.concurrent('renders lyrics_two_voices.png', async () => {
		expect(
			await scores.screenshot('lyrics_two_voices.musicxml'),
	...
	it.concurrent('renders rehearsal.png', async () => {
		expect(await scores.screenshot('rehearsal.musicxml')).toMatchScreenshot(
			'rehearsal.png',
		);
	});
	...
	it.concurrent('renders measures_two.png', async () => {
		expect(await scores.screenshot('measures_two.musicxml')).toMatchScreenshot(
			'measures_two.png',
		);
	});
	...
	it.concurrent('renders measures_end_barline.png', async () => {
		expect(
			await scores.screenshot('measures_end_barline.musicxml'),
	...
	it.concurrent('renders measures_light_light.png', async () => {
		expect(
			await scores.screenshot('measures_light_light.musicxml'),
	...
	it.concurrent('renders barline_styles.png', async () => {
		expect(
			await scores.screenshot('barline_styles.musicxml'),
	...
	it.concurrent('renders barline_mid_measure.png', async () => {
		expect(
			await scores.screenshot('barline_mid_measure.musicxml'),
	...
	it.concurrent('renders pickup_measure.png', async () => {
		expect(
			await scores.screenshot('pickup_measure.musicxml'),
	...
	it.concurrent('renders repeats.png', async () => {
		expect(await scores.screenshot('repeats.musicxml')).toMatchScreenshot(
			'repeats.png',
		);
	});
	...
	it.concurrent('renders repeats_notation_and_tab.png', async () => {
		expect(
			await scores.screenshot('repeats_notation_and_tab.musicxml'),
	...
	it.concurrent('renders repeats_multiple_times.png', async () => {
		expect(
			await scores.screenshot('repeats_multiple_times.musicxml'),
	...
	it.concurrent('renders repeats_nested.png', async () => {
		expect(
			await scores.screenshot('repeats_nested.musicxml'),
	...
	it.concurrent('renders measures_gap.png', async () => {
		expect(
			await scores.screenshot('measures_two.musicxml', {
				measureNumbering: 'every',
				gaps: [
					{
	...
	it.concurrent('renders beam_variations.png', async () => {
		expect(
			await scores.screenshot('beam_variations.musicxml'),
	...
	it.concurrent('renders chord.png', async () => {
		expect(await scores.screenshot('chord.musicxml')).toMatchScreenshot(
			'chord.png',
		);
	});
	...
	it.concurrent('renders ledger_lines.png', async () => {
		expect(await scores.screenshot('ledger_lines.musicxml')).toMatchScreenshot(
			'ledger_lines.png',
		);
	});
	...
	it.concurrent('renders tie.png', async () => {
		expect(await scores.screenshot('tie.musicxml')).toMatchScreenshot(
			'tie.png',
		);
	});
	...
	it.concurrent('renders tie_chain.png', async () => {
		expect(await scores.screenshot('tie_chain.musicxml')).toMatchScreenshot(
			'tie_chain.png',
		);
	});
	...
	it.concurrent('renders tie_chord_triad.png', async () => {
		expect(
			await scores.screenshot('tie_chord_triad.musicxml'),
	...
	it.concurrent('renders tie_chord_dyad.png', async () => {
		expect(
			await scores.screenshot('tie_chord_dyad.musicxml'),
	...
	it.concurrent('renders tie_chord_octave.png', async () => {
		expect(
			await scores.screenshot('tie_chord_octave.musicxml'),
	...
	it.concurrent('renders tie_chord_second.png', async () => {
		expect(
			await scores.screenshot('tie_chord_second.musicxml'),
	...
	it.concurrent('renders tie_chord_cluster.png', async () => {
		expect(
			await scores.screenshot('tie_chord_cluster.musicxml'),
	...
	it.concurrent('renders tie_system_break.png', async () => {
		expect(
			await scores.screenshot('tie_system_break.musicxml', {
	...
	it.concurrent('renders slur_default.png', async () => {
		expect(await scores.screenshot('slur_default.musicxml')).toMatchScreenshot(
			'slur_default.png',
		);
	});
	...
	it.concurrent('renders slur_above.png', async () => {
		expect(await scores.screenshot('slur_above.musicxml')).toMatchScreenshot(
			'slur_above.png',
		);
	});
	...
	it.concurrent('renders slur_stem_up.png', async () => {
		expect(await scores.screenshot('slur_stem_up.musicxml')).toMatchScreenshot(
			'slur_stem_up.png',
		);
	});
	...
	it.concurrent('renders slur_mixed_stems.png', async () => {
		expect(
			await scores.screenshot('slur_mixed_stems.musicxml'),
	...
	it.concurrent('renders slur_leap.png', async () => {
		expect(await scores.screenshot('slur_leap.musicxml')).toMatchScreenshot(
			'slur_leap.png',
		);
	});
	...
	it.concurrent('renders slur_beamed.png', async () => {
		expect(await scores.screenshot('slur_beamed.musicxml')).toMatchScreenshot(
			'slur_beamed.png',
		);
	});
	...
	it.concurrent('renders slur_multiple.png', async () => {
		expect(await scores.screenshot('slur_multiple.musicxml')).toMatchScreenshot(
			'slur_multiple.png',
		);
	});
	...
	it.concurrent('renders slur_chained.png', async () => {
		expect(await scores.screenshot('slur_chained.musicxml')).toMatchScreenshot(
			'slur_chained.png',
		);
	});
	...
	it.concurrent('renders slur_system_break.png', async () => {
		expect(
			await scores.screenshot('slur_system_break.musicxml', {
	...
	it.concurrent('renders slur_line_types.png', async () => {
		expect(
			await scores.screenshot('slur_line_types.musicxml'),
	...
	it.concurrent('renders slur_backup_voices.png', async () => {
		expect(
			await scores.screenshot('slur_backup_voices.musicxml'),
	...
	it.concurrent('renders slur_cross_stave.png', async () => {
		expect(
			await scores.screenshot('slur_cross_stave.musicxml'),
	...
	it.concurrent('renders pedal.png', async () => {
		expect(await scores.screenshot('pedal.musicxml')).toMatchScreenshot(
			'pedal.png',
		);
	});
	...
	it.concurrent('renders tab_hammer_pull.png', async () => {
		expect(
			await scores.screenshot('tab_hammer_pull.musicxml'),
	...
	it.concurrent('renders tab_tie.png', async () => {
		expect(await scores.screenshot('tab_tie.musicxml')).toMatchScreenshot(
			'tab_tie.png',
		);
	});
	...
	it.concurrent('renders tab_grace.png', async () => {
		expect(await scores.screenshot('tab_grace.musicxml')).toMatchScreenshot(
			'tab_grace.png',
		);
	});
	...
	it.concurrent('renders tab_grace_notation_align.png', async () => {
		expect(
			await scores.screenshot('tab_grace_notation_align.musicxml'),
	...
	it.concurrent('renders tab_grace_chord_align.png', async () => {
		expect(
			await scores.screenshot('tab_grace_chord_align.musicxml'),
	...
	it.concurrent('renders tab_slide.png', async () => {
		expect(await scores.screenshot('tab_slide.musicxml')).toMatchScreenshot(
			'tab_slide.png',
		);
	});
	...
	it.concurrent('renders tab_slide_text.png', async () => {
		expect(
			await scores.screenshot('tab_slide.musicxml', {
	...
	it.concurrent('renders tab_slide_notation.png', async () => {
		expect(
			await scores.screenshot('tab_slide_notation.musicxml'),
	...
	it.concurrent('renders slide_in.png', async () => {
		expect(await scores.screenshot('slide_in.musicxml')).toMatchScreenshot(
			'slide_in.png',
		);
	});
	...
	it.concurrent('renders slide_out.png', async () => {
		expect(await scores.screenshot('slide_out.musicxml')).toMatchScreenshot(
			'slide_out.png',
		);
	});
	...
	it.concurrent('renders tab_bend.png', async () => {
		expect(await scores.screenshot('tab_bend.musicxml')).toMatchScreenshot(
			'tab_bend.png',
		);
	});
	...
	it.concurrent('renders tab_vibrato.png', async () => {
		expect(await scores.screenshot('tab_vibrato.musicxml')).toMatchScreenshot(
			'tab_vibrato.png',
		);
	});
	...
	it.concurrent('renders tab_annotation.png', async () => {
		expect(
			await scores.screenshot('tab_annotation.musicxml'),
	...
	it.concurrent('renders tab_words_align.png', async () => {
		expect(
			await scores.screenshot('tab_words_align.musicxml'),
	...
	it.concurrent('renders tab_chord.png', async () => {
		expect(await scores.screenshot('tab_chord.musicxml')).toMatchScreenshot(
			'tab_chord.png',
		);
	});
	...
	it.concurrent('renders tab_harmonic.png', async () => {
		expect(await scores.screenshot('tab_harmonic.musicxml')).toMatchScreenshot(
			'tab_harmonic.png',
		);
	});
	...
	it.concurrent('renders notehead_x.png', async () => {
		expect(await scores.screenshot('notehead_x.musicxml')).toMatchScreenshot(
			'notehead_x.png',
		);
	});
	...
	it.concurrent('renders notehead_parentheses.png', async () => {
		expect(
			await scores.screenshot('notehead_parentheses.musicxml'),
	...
	it.concurrent('renders notehead_slash.png', async () => {
		expect(
			await scores.screenshot('notehead_slash.musicxml'),
	...
	it.concurrent('renders notehead_shapes.png', async () => {
		expect(
			await scores.screenshot('notehead_shapes.musicxml'),
	...
	it.concurrent('renders notehead_shapes_extended.png', async () => {
		expect(
			await scores.screenshot('notehead_shapes_extended.musicxml'),
	...
	it.concurrent('renders tab_notation_rest.png', async () => {
		expect(
			await scores.screenshot('tab_notation_rest.musicxml'),
	...
	it.concurrent('renders tab_notation_durations.png', async () => {
		expect(
			await scores.screenshot('tab_notation_durations.musicxml'),
	...
	it.concurrent('renders tuplet_triplet.png', async () => {
		expect(
			await scores.screenshot('tuplet_triplet.musicxml'),
	...
	it.concurrent('renders tuplet_nested.png', async () => {
		expect(await scores.screenshot('tuplet_nested.musicxml')).toMatchScreenshot(
			'tuplet_nested.png',
		);
	});
	...
	it.concurrent('renders tuplet_display.png', async () => {
		expect(
			await scores.screenshot('tuplet_display.musicxml'),
	...
	it.concurrent('renders articulations.png', async () => {
		expect(await scores.screenshot('articulations.musicxml')).toMatchScreenshot(
			'articulations.png',
		);
	});
	...
	it.concurrent('renders articulations_extended.png', async () => {
		expect(
			await scores.screenshot('articulations_extended.musicxml'),
	...
	it.concurrent('renders ornaments.png', async () => {
		expect(await scores.screenshot('ornaments.musicxml')).toMatchScreenshot(
			'ornaments.png',
		);
	});
	...
	it.concurrent('renders tremolo.png', async () => {
		expect(await scores.screenshot('tremolo.musicxml')).toMatchScreenshot(
			'tremolo.png',
		);
	});
	...
	it.concurrent('renders technical_marks.png', async () => {
		expect(
			await scores.screenshot('technical_marks.musicxml'),
	...
	it.concurrent('renders fingering.png', async () => {
		expect(await scores.screenshot('fingering.musicxml')).toMatchScreenshot(
			'fingering.png',
		);
	});
	...
	it.concurrent('renders string_numbers.png', async () => {
		expect(
			await scores.screenshot('string_numbers.musicxml'),
	...
	it.concurrent('renders fermata.png', async () => {
		expect(await scores.screenshot('fermata.musicxml')).toMatchScreenshot(
			'fermata.png',
		);
	});
	...
	it.concurrent('renders arpeggio.png', async () => {
		expect(await scores.screenshot('arpeggio.musicxml')).toMatchScreenshot(
			'arpeggio.png',
		);
	});
	...
	it.concurrent('renders non_arpeggiate.png', async () => {
		expect(
			await scores.screenshot('non_arpeggiate.musicxml'),
	...
	it.concurrent('renders harmony.png', async () => {
		expect(await scores.screenshot('harmony.musicxml')).toMatchScreenshot(
			'harmony.png',
		);
	});
	...
	it.concurrent('renders harmony_grace.png', async () => {
		expect(await scores.screenshot('harmony_grace.musicxml')).toMatchScreenshot(
			'harmony_grace.png',
		);
	});
	...
	it.concurrent('renders harmony_kinds.png', async () => {
		expect(await scores.screenshot('harmony_kinds.musicxml')).toMatchScreenshot(
			'harmony_kinds.png',
		);
	});
	...
	it.concurrent('renders figured_bass.png', async () => {
		expect(await scores.screenshot('figured_bass.musicxml')).toMatchScreenshot(
			'figured_bass.png',
		);
	});
	...
	it.concurrent('renders chord_diagram.png', async () => {
		expect(await scores.screenshot('chord_diagram.musicxml')).toMatchScreenshot(
			'chord_diagram.png',
		);
	});
	...
	it.concurrent('renders chord_diagram_adjacent.png', async () => {
		expect(
			await scores.screenshot('chord_diagram_adjacent.musicxml', {
	...
	it.concurrent('renders chord_diagram_edge.png', async () => {
		expect(
			await scores.screenshot('chord_diagram_edge.musicxml', {
				layout: { type: 'standard', referenceWidth: 500 },
			}),
	...
	it.concurrent('renders chord_diagram_lower_part.png', async () => {
		expect(
			await scores.screenshot('chord_diagram_lower_part.musicxml'),
	...
	it.concurrent('renders harmonic.png', async () => {
		expect(await scores.screenshot('harmonic.musicxml')).toMatchScreenshot(
			'harmonic.png',
		);
	});
	...
	it.concurrent('renders grace_notes.png', async () => {
		expect(await scores.screenshot('grace_notes.musicxml')).toMatchScreenshot(
			'grace_notes.png',
		);
	});
	...
	it.concurrent('renders grace_bass_clef.png', async () => {
		expect(
			await scores.screenshot('grace_bass_clef.musicxml'),
	...
	it.concurrent('renders grace_spacing.png', async () => {
		expect(await scores.screenshot('grace_spacing.musicxml')).toMatchScreenshot(
			'grace_spacing.png',
		);
	});
	...
	it.concurrent('renders grace_chord.png', async () => {
		expect(await scores.screenshot('grace_chord.musicxml')).toMatchScreenshot(
			'grace_chord.png',
		);
	});
	...
	it.concurrent('renders grace_after.png', async () => {
		expect(await scores.screenshot('grace_after.musicxml')).toMatchScreenshot(
			'grace_after.png',
		);
	});
	...
	it.concurrent('renders two_voices.png', async () => {
		expect(await scores.screenshot('two_voices.musicxml')).toMatchScreenshot(
			'two_voices.png',
		);
	});
	...
	it.concurrent('renders voices_grand_staff.png', async () => {
		expect(
			await scores.screenshot('voices_grand_staff.musicxml'),
	...
	it.concurrent('renders cross_stave.png', async () => {
		expect(await scores.screenshot('cross_stave.musicxml')).toMatchScreenshot(
			'cross_stave.png',
		);
	});
	...
	it.concurrent('renders staves_different_keys.png', async () => {
		expect(
			await scores.screenshot('staves_different_keys.musicxml'),
	...
	it.concurrent('renders staff_dynamics.png', async () => {
		expect(
			await scores.screenshot('staff_dynamics.musicxml'),
	...
	it.concurrent('renders transpose.png', async () => {
		expect(await scores.screenshot('transpose.musicxml')).toMatchScreenshot(
			'transpose.png',
		);
	});
	...
	it.concurrent('renders transpose_change.png', async () => {
		expect(
			await scores.screenshot('transpose_change.musicxml'),
	...
	it.concurrent('renders system_break.png', async () => {
		expect(await scores.screenshot('system_break.musicxml')).toMatchScreenshot(
			'system_break.png',
		);
	});
	...
	it.concurrent('renders print_new_system.png', async () => {
		expect(
			await scores.screenshot('print_new_system.musicxml'),
	...
	it.concurrent('renders layout_panoramic.png', async () => {
		expect(
			await scores.screenshot('system_break.musicxml', {
	...
	it.concurrent('renders overflow_wrap.png', async () => {
		expect(
			await scores.screenshot('overflow_forced_line.musicxml'),
	...
	it.concurrent('renders stretch_single_system_off.png', async () => {
		expect(
			await scores.screenshot('aloof_measure_1.musicxml', {
	...
	it.concurrent('renders system_spacing.png', async () => {
		expect(
			await scores.screenshot('system_spacing.musicxml', {
	...
	it.concurrent('renders stave_spacing.png', async () => {
		expect(await scores.screenshot('stave_spacing.musicxml')).toMatchScreenshot(
			'stave_spacing.png',
		);
	});
	...
	it.concurrent('renders stave_spacing_dynamic.png', async () => {
		expect(
			await scores.screenshot('stave_spacing_dynamic.musicxml'),
	...
	it.concurrent('renders part_spacing.png', async () => {
		expect(await scores.screenshot('part_spacing.musicxml')).toMatchScreenshot(
			'part_spacing.png',
		);
	});
	...
	it.concurrent('renders score_chopin_prelude.png', async () => {
		expect(
			await scores.screenshot('score_chopin_prelude.musicxml'),
	...
	it.concurrent('renders score_brahms_violin_concerto.png', async () => {
		expect(
			await scores.screenshot('score_brahms_violin_concerto.musicxml'),
	...
	it.concurrent('renders score_faure_apres_un_reve.png', async () => {
		expect(
			await scores.screenshot('score_faure_apres_un_reve.musicxml'),
	...
	it.concurrent('renders score_mozart_string_quartet.png', async () => {
		expect(
			await scores.screenshot('score_mozart_string_quartet.musicxml'),
	...
	it.concurrent('renders score_debussy_mandoline.png', async () => {
		expect(
			await scores.screenshot('score_debussy_mandoline.musicxml'),
	...
	it.concurrent('renders score_beethoven_an_die_ferne_geliebte.png', async () => {
		expect(
			await scores.screenshot('score_beethoven_an_die_ferne_geliebte.musicxml'),
	...
	it.concurrent('renders score_wanna_skip_class.png', async () => {
		expect(
			await scores.screenshot('score_wanna_skip_class.musicxml'),
	...
	it.concurrent('renders score_mozart_an_chloe.png', async () => {
		expect(
			await scores.screenshot('score_mozart_an_chloe.musicxml'),
	...
	it.concurrent('renders score_bach_air.png', async () => {
		expect(
			await scores.screenshot('score_bach_air.musicxml'),
	...
	it.concurrent('renders score_mozart_das_veilchen.png', async () => {
		expect(
			await scores.screenshot('score_mozart_das_veilchen.musicxml'),
	...
	it.concurrent('renders score_land_der_berge.png', async () => {
		expect(
			await scores.screenshot('score_land_der_berge.musicxml'),
	...
	it.concurrent('renders score_amazing_grace.png', async () => {
		expect(
			await scores.screenshot('score_amazing_grace.musicxml'),
	...
	it.concurrent('renders score_greens_greenery.png', async () => {
		expect(
			await scores.screenshot('score_greens_greenery.musicxml'),
	...
	it.concurrent('renders score_joplin_elite_syncopations.png', async () => {
		expect(
			await scores.screenshot('score_joplin_elite_syncopations.musicxml'),
