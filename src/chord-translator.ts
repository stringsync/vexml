 ...
 * draws it: its keys, noteheads, accidentals, dots and stem. What hangs OFF the note once
 * it exists (articulations, ornaments, lyrics) is NotationTranslator's half.
 */
