...
import type { Layer, LayerHost } from '../host/stage';
import type { Decoratable, Decorator } from './element';

/*
 * The decoration store and painter — the production `Decorator`. An element's color/halo toggles
 * delegate here. Decorations are retained as active sets (which elements are colored/haloed) and
