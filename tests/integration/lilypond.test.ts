...
describe('lilypond', () => {
  ...
  it.each<TestCase>([
    { exampleId: '01a-Pitches-Pitches.xml', viewport: { width: 1920, height: 1080 } },
    { exampleId: '01a-Pitches-Pitches.xml', viewport: { width: 360, height: 800 } },
  ])(`renders: $exampleId ($viewport.width X $viewport.height)`, async (t) => {
    await page.setViewport(t.viewport);

    const div = document.createElement('div');
    div.setAttribute('id', 'screenshot');

    Vexml.render({ element: div, xml: XML, width: t.viewport.width - 16 });
