...
describe(QuadTree, () => {
  ...
  beforeEach(() => {
    const boundary = new LegacyRect(0, 0, 100, 100);
  ...
  describe('insert', () => {
    ...
    it('should query points within a given range', () => {
      ...
      const result = tree.query(new LegacyRect(0, 0, 25, 25));
    ...
    it('should return an empty array when no points are found within the range', () => {
      ...
      const result = tree.query(new LegacyRect(100, 100, 150, 150));
  ...
  describe('query', () => {
    it('should return an empty array when no points are found within the range', () => {
      ...
      const result = tree.query(new LegacyRect(50, 50, 60, 60));
      expect(result).toBeEmpty();
    });
    ...
    it('should return all points within the range when the range covers the entire quad tree', () => {
      ...
      const result = tree.query(new LegacyRect(0, 0, 100, 100));
    ...
    it('should return points within the range when the range partially overlaps with the quad tree', () => {
      ...
      const result = tree.query(new LegacyRect(15, 15, 35, 35));
